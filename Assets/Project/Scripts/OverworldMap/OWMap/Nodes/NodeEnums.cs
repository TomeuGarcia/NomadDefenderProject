...
namespace NodeEnums
{
    ...
    public enum UpgradeType { NEW_TURRET_CARD, REPLACE_ATTACK_PART, REPLACE_BODY_PART, REPLACE_BASE_PART, ADD_BONUS_STATS_PART, COPY_ABILITY, COUNT } // TODO add more types
