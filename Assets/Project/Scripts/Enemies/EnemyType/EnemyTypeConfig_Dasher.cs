...
public class EnemyTypeConfig_Dasher : EnemyTypeConfig
{
    ...
    [SerializeField, Min(0)] private float _speedBoosterInteractionMultiplier = 0.1f;
        
        
        
    public float StopDuration => _stopDuration;
    public float DashTravelDistance => _dashTravelDistance;
    public float SpeedBoosterInteractionMultiplier => _speedBoosterInteractionMultiplier;
